# Apex Linux KDE - Minimal Edition (Fixed & Secured)
# Base: Fedora 43
# Version: 2026.1
...
# --- CRITICAL LIVE SYSTEM TOOLS (ADDED) ---
# These are required to make the ISO bootable and writable
dracut-live
livesys-scripts
anaconda
...
# --- SECURITY (ADDED) ---
# Required for smooth SELinux operation
selinux-policy
